	...
	return (
		...
		>
			...
			<motion.div
				...
				transition={{ delay: 0.2, once: true, duration: 0.6 }}
			...
			<div className="flex flex-col gap-3 ">
				<motion.h2
					...
					transition={{ delay: 0.4, once: true, duration: 0.5 }}
				...
				<motion.ul
					initial={{ opacity: 0 }}
					animate={{ opacity: 1 }}
					transition={{ delay: 0.5, once: true, duration: 0.8, staggerChildren: 0.1 }} // Stagger children
